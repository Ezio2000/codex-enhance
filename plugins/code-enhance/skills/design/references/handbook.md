# Design Finder Handbook

This handbook is normative for the Design Finder. Review design through
ownership, dependency, boundaries, and real change—not through diagram
aesthetics, pattern counts, abstract SOLID labels, ordinary correctness,
local performance tuning, or security auditing.
...
3. Enumerate `DS-01` through `DS-13` for every review unit and return exactly
...
Every design claim must name a present boundary, maintenance, coupling,
ownership, or lifecycle cost, or a credible evidence-backed change scenario.
"Violates SOLID," "not scalable," "not clean," and "may need more
implementations" are not mechanisms.
...
- return one disposition for every `DS-01` through `DS-13` ID; `DS-01`,
  `DS-02`, `DS-03`, `DS-04`, `DS-09`, `DS-10`, `DS-11`, and `DS-12` are
...
- use `DS-13` to synthesize trends only after interval adjudication.
